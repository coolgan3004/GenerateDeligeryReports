...
if (Test-Path $PublishDir) {
    Write-Host "`n[1/5] Cleaning previous publish output..." -ForegroundColor Yellow
...
Write-Host "`n[3/5] Copying report template..." -ForegroundColor Yellow
...
Write-Host "`n[4/5] Updating appsettings.json for deployment..." -ForegroundColor Yellow
...
Write-Host "`n[5/5] Deploying to $TargetPath ..." -ForegroundColor Yellow
